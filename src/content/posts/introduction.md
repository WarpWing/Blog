...
I'm not sure what my first topic is going to be about. It's likely going to be about my time at SkyCrypt and the challenges that come with developing and scaling an application that's recieved 300k+ total users, billions of requests and over 250TB (factoring in site + API traffic) of outbound data over 4 years of uptime. 
Full transparency, I will say that those numbers may be inaccurate because Cloudflare's Web Analytics only retain up to 30 days. SkyCrypt often averages 6-8 TB a month, more towards 7-8 at it's apex. Regardless, if you find my blogs interesting or the topics excited, feel free to stick around! 
